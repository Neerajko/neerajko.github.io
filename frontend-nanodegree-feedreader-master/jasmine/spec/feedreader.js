...
$(function() {
    ...
    describe('The menu', function() {
        ...
        it('is hidden by default', function() {
            var hideVisible = $('body').hasClass('menu-hidden');
            expect(hideVisible).toBeTruthy();
        });
         ...
         */
        it('change the visibility when clicked', function() {
            var button = $('.menu-icon-link');
            var body = $('body');

            button.trigger('click');
            var bodyAfterClick = body.attr('class');
            expect(bodyAfterClick).toBeFalsy();

            button.trigger('click');
            var bodyAfterClick = body.attr('class');
            expect(bodyAfterClick).toBe('menu-hidden');
        });
    });
    ...
    describe('New Feed Selection', function() {
        ...
        it('change the content when feed is loaded', function(done) {
            loadFeed(1, function() {
